...
interface DammStableIconProps {
  size?: number;
}

const DammStableIcon: React.FC<DammStableIconProps> = ({ size = 24 }) => {
  return (
    <div
      className="rounded-full border border-[#2775CA] flex items-center justify-center"
