...
export default function ThesisCard() {
  return (
    <Card
      className="!max-w-full w-full min-w-0 !h-auto overflow-hidden max-w-[800px] min-w-[300px]"
      variant="fund"
    >
      <div className="flex flex-wrap gap-4">
        {/* Column 1 */}
        <div className="min-w-0 grow basis-[clamp(16rem,45%,32rem)]">
          ...
          <ul className="list-disc list-outside pl-6 text-sm text-neutral font-montserrat leading-snug whitespace-normal break-words [overflow-wrap:anywhere] hyphens-auto">
            ...
            <li>Assets are invested in short-term unleveraged concentrated liquidity positions.</li>
