import { ChartDataType } from "@/services/api/types/snapshot";
...
export default function AreaChart({ data }: { data: ChartDataType }) {
      ...
      {({ width, height: parentHeight }) => (
        <div
          onMouseMove={(e) => {
            ...
            const allData = Object.entries(data).flatMap(([vaultId, vaultData]) =>
            ...
            createPortal(
              ...
              >
                <div className="space-y-0.5">
                  ...
                  <div className="text-xs text-gray-600 dark:text-gray-400">{tooltip.content}</div>
